...
calculateHRV <- function(beats, windowsize = 300) {
    result = list()
...
getHRVData <- function(beats, windowsize = 300, shift = 300, mod.fit = NULL) {
    ...
    HRVData = lapply(winsBeatData, calculateHRV, windowsize = windowsize)
    return(HRVData)
}
...
getHRVFeatures <- function(HRVData, windowsize = 300, shift = 300, mod.fit = NULL) {
    ...
    results$CalculatedData = lapply(beatLists, getHRVData, windowsize = 300, shift = 300, mod.fit = NULL)
