...
class DM:
    ...
    def CalculateFrameBasedParams(self, showProgress=False):
        ...
        while indexframe<numframes and KeepGoing:
            ...
            self.data["SD1"].append("{0:.2G} msec.".format(sd1))
            self.data["SD2"].append("{0:.2G} msec.".format(sd2))
        ...
        data = {}
        data["ULF"]=self.data["ULF"].tolist()
        data["VLF"]=self.data["VLF"].tolist()
        data["LF"]=self.data["LF"].tolist()
        data["HF"]=self.data["HF"].tolist()
        data["LFHF"]=self.data["LFHF"].tolist()
        data["Power"]=self.data["Power"].tolist()
        data["Mean HR"]=self.data["Mean HR"].tolist()
        data["HR STD"]=self.data["HR STD"].tolist()
        data["pNN50"]=self.data["pNN50"].tolist()
        data["rMSSD"]=self.data["rMSSD"].tolist()
        data["ApEn"]=self.data["ApEn"].tolist()
        data["FracDim"]=self.data["FracDim"].tolist()
        data["SD1"]=self.data["SD1"]
        data["SD2"]=self.data["SD2"]
