...
public interface StudentsDAO {
	...
	public HashMap<String, Object> getStudentAttendanceStats(int school_id, String grade, String student_class, String inputdate);

	public HashMap<String, Object> getAbsentAbnormalStudentsList(int school_id, String grade, String student_class, String inputdate);
	...
	public boolean updateStudentsApi(Users loginUser, StudentsModel studentsModel, Students student);
	
	public int deleteStudentApi(int studentId);

	public HashMap<String, Object> getStudentRewardRankings(int school_id, String startdate, String enddate, String grade);

	HashMap<String, Object> getStudentRewards(int student_id);
}
