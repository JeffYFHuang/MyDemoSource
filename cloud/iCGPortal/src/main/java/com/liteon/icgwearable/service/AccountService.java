...
public interface AccountService {
	...
	public List<DeviceConfigurations> getDeviceConfigurationList(int start, int total, String device_model);
	...
	public int getTotalNoofFirrmWare(String modelSelectedValue);
