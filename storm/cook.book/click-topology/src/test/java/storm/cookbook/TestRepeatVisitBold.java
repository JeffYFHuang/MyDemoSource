...
public class TestRepeatVisitBold extends StormTestCase {
    ...
    public static Collection<Object[]> data() {
        Object[][] data = new Object[][] { { "172.18.161.250", "Client1", "myintranet.com", "false"  },
                { "172.18.161.250", "Client1", "myintranet.com", "false" } ,
                { "172.18.161.253", "Client2", "myintranet1.com", "true" },
                { "172.18.161.254", "Client3", "myintranet2.com", "false"}};
    ...
    public void testExecute(){
        ...
        config.put(Conf.REDIS_HOST_KEY, "localhost");
        config.put(Conf.REDIS_PORT_KEY, "6379");
